...
public class GravititeOreBlockBlock extends AetherrebornModElements.ModElement {
	@ObjectHolder("aetherreborn:gravitite_ore_block")
	public static final Block block = null;
	public GravititeOreBlockBlock(AetherrebornModElements instance) {
		super(instance, 65);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("gravitite_ore_block");
		}
