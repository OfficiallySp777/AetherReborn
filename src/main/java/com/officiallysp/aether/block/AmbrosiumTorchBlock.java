...
public class AmbrosiumTorchBlock extends AetherrebornModElements.ModElement {
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			super(Block.Properties.create(Material.WOOD).sound(SoundType.WOOD).hardnessAndResistance(1f, 10f).lightValue(2).doesNotBlockMovement()
					.notSolid());
			setRegistryName("ambrosium_torch");
		}
