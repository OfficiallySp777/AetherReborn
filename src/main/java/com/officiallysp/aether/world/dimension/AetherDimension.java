...
package com.officiallysp.aether.world.dimension;
...
public class AetherDimension extends AetherrebornModElements.ModElement {
	...
	public static class CustomPortalBlock extends NetherPortalBlock {
		...
		private TeleporterDimensionMod getTeleporterForDimension(Entity entity, BlockPos pos, ServerWorld nextWorld) {
			BlockPattern.PatternHelper bph = AetherDimension.CustomPortalBlock.createPatternHelper(entity.world, new BlockPos(pos));
