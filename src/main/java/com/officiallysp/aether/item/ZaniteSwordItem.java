...
public class ZaniteSwordItem extends AetherrebornModElements.ModElement {
	@ObjectHolder("aetherreborn:zanite_sword")
	public static final Item block = null;
	public ZaniteSwordItem(AetherrebornModElements instance) {
		super(instance, 32);
	}
