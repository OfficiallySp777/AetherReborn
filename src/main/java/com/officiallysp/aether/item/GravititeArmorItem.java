...
public class GravititeArmorItem extends AetherrebornModElements.ModElement {
	@ObjectHolder("aetherreborn:gravitite_armorhelmet")
	public static final Item helmet = null;
	@ObjectHolder("aetherreborn:gravitite_armorbody")
	public static final Item body = null;
	@ObjectHolder("aetherreborn:gravitite_armorlegs")
